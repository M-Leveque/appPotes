...
<header>
    ...
    <g class="nc-icon-wrapper js-transition-icon" data-effect="scale" data-event="click">
        <g class="js-transition-icon__state" transform="translate(0 0) scale(1)" style="display: block;">
			...
			c-12.3,0-22.1,9.8-22.1,22.1s10,22.3,22.3,22.3s22.3-10,22.3-22.3S42.4,7.8,30.2,7.8z" style="" fill=" url(#SVGID_1_)"/>
                </g>
                <g>
                    <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="21.5286" y1="24.9407" x2="38.8088" y2="34.9174">
                        <stop offset="0" style="stop-color:#8EC5FC"/>
                        <stop offset="1" style="stop-color:#E0C3FC"/>
                    </linearGradient>
                    <path class="st1" d="M40.2,31.4H20.3c-0.8,0-1.5-0.6-1.5-1.5c0-0.8,0.6-1.5,1.5-1.5H40c0.8,0,1.5,0.6,1.5,1.5
			C41.5,30.7,40.8,31.4,40.2,31.4z" style="" fill=" url(#SVGID_2_)"/>
                </g>
                <g>
                    <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="24.6472" y1="26.7412" x2="35.6855" y2="33.1142">
                        <stop offset="0" style="stop-color:#8EC5FC"/>
                        <stop offset="1" style="stop-color:#E0C3FC"/>
                    </linearGradient>
                    <path class="st2" d="M30.2,41.2c-0.8,0-1.5-0.6-1.5-1.5V20.1c0-0.8,0.6-1.5,1.5-1.5c0.8,0,1.5,0.6,1.5,1.5v19.7
			C31.6,40.6,31,41.2,30.2,41.2z" style="" fill=" url(#SVGID_3_)"/>
                </g>
            </g>
        </g>
        <g class="js-transition-icon__state" style="display: none;" transform="translate(5.999999999999998 5.999999999999998) scale(0.80)" aria-hidden="true">
            <g>
                <g>
                    ...
                    <path class="st0" d="M43.3,47.9L12.2,16.8c-1.3-1.3-1.3-3.3,0-4.6s3.3-1.3,4.6,0l30.9,30.9c1.3,1.3,1.3,3.3,0,4.6
			C46.4,48.9,44.3,48.9,43.3,47.9z" style="" fill=" url(#SVGID_1_)"/>
                </g>
                <g>
                    <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="11.257" y1="29.9125" x2="48.5757" y2="29.9125">
                        <stop offset="0" style="stop-color:#8EC5FC"/>
                        <stop offset="1" style="stop-color:#E0C3FC"/>
                    </linearGradient>
                    <path class="st1" d="M12.2,47.6c-1.3-1.3-1.3-3.3,0-4.6l30.9-30.9c1.3-1.3,3.3-1.3,4.6,0c1.3,1.3,1.3,3.3,0,4.6L16.8,47.6
			C15.5,48.9,13.5,48.9,12.2,47.6z" style="" fill=" url(#SVGID_2_)"/>
                </g>
            </g>
        </g>
    </g>
...
<section id="add-menu">
	<ul>
		...
		<a class="reveal" href="#"><li><div class="icon-btn icon icon-add-calendar"></div></li>Ajouter<br>un événement</a>
